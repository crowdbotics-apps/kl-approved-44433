"""
Django settings for kl_approved_44433 project.
...
ROOT_URLCONF = 'kl_approved_44433.urls'
...
WSGI_APPLICATION = 'kl_approved_44433.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "kl_approved_44433 API",
    "DESCRIPTION": "API documentation for kl_approved_44433 App",
    "VERSION": "v1",
}
